...
import ca.prusikti.test.jhipster.application.JhipsterSampleApplicationApp;
import ca.prusikti.test.jhipster.application.domain.Authority;
import ca.prusikti.test.jhipster.application.domain.User;
import ca.prusikti.test.jhipster.application.repository.AuthorityRepository;
import ca.prusikti.test.jhipster.application.repository.UserRepository;
import ca.prusikti.test.jhipster.application.security.AuthoritiesConstants;
import ca.prusikti.test.jhipster.application.service.MailService;
import ca.prusikti.test.jhipster.application.service.dto.UserDTO;
import ca.prusikti.test.jhipster.application.web.rest.errors.ExceptionTranslator;
import ca.prusikti.test.jhipster.application.web.rest.vm.KeyAndPasswordVM;
import ca.prusikti.test.jhipster.application.web.rest.vm.ManagedUserVM;
import ca.prusikti.test.jhipster.application.service.UserService;
